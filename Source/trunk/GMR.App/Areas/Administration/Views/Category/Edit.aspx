<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Administration/Views/Shared/CMS.Master" Inherits="System.Web.Mvc.ViewPage<GMR.App.Areas.Administration.Models.EditCategoryModel>" %>
...
<h2>&nbsp;</h2>
<% using (Html.BeginForm("Edit", "Category", FormMethod.Post, new { @class = "search_form general_form", enctype = "multipart/form-data" }))
   { %>
													...
													<fieldset>
                                                        ...
                                                        <div class="row">
                                                         ...
                                                         <div class="row">
															...
															<div class="inputs">
																<span class="input_wrapper">
                                                                    <label> <%=Html.RadioButton("AccessTypes", GMR.Biz.Models.AccessTypes.Free, Model.AccessTypes == GMR.Biz.Models.AccessTypes.Free.ToString())%> Miễn Phí</label>
                                                                    <br />
                                                                    <label> <%=Html.RadioButton("AccessTypes", GMR.Biz.Models.AccessTypes.Login, Model.AccessTypes == GMR.Biz.Models.AccessTypes.Login.ToString())%> Đăng nhập</label>
                                                                    <br />
                                                                     <label> <%=Html.RadioButton("AccessTypes", GMR.Biz.Models.AccessTypes.SMS, Model.AccessTypes == GMR.Biz.Models.AccessTypes.SMS.ToString())%>Tin nhắn</label>
                                                                </span>
                                                                <%=Html.ValidationMessageFor(model => model.ParentCategoryID)%>
																<span class="system positive"></span>
															</div>
