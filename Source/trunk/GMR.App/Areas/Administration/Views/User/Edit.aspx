<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Administration/Views/Shared/CMS.Master" Inherits="System.Web.Mvc.ViewPage<GMR.App.Areas.Administration.Models.EditUserModel>" %>
...
<h2>&nbsp;</h2>
<% using (Html.BeginForm("Edit","User", FormMethod.Post, new {@class="search_form general_form"}))
   { %>
													...
													<fieldset>
														...
														<div class="row">
															...
															<div class="inputs">
                                                                ...
                                                                <% = Html.TextBoxFor(p=>p.Username, new {@class="text", @readonly="true", disabled="disabled"}) %>
                                                                </span>
