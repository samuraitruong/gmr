<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Administration/Views/Shared/CMS.Master" Inherits="System.Web.Mvc.ViewPage<GMR.App.Areas.Administration.Models.IndexPriceModel>" %>
									...
									<div class="sct_right">
										<div class="sct_left">
											<div class="sct_right">
												...
												<div class="table_wrapper">
													...
													<table cellpadding="0" cellspacing="0" width="100%">
														<tbody><tr>
															<th>Đối tác</th>
															<th><a href="#">Loại</a></th>
															<th><a href="#" class="asc">Địa phương</a></th>
															<th><a href="#" class="desc">Mua</a></th>
															<th><a href="#">Bán</a></th>
															<th><a href="#">Mở cửa</a></th>
                                                            <th><a href="#">Đóng cửa</a></th>
                                                           
                                                            <th><a href="#">Tăng giảm</a></th>
                                                            <th><a href="#">Tăng giảm (%)</a></th>
                                                            <th><a href="#">Cập nhật lúc</a></th>
														...
														<tr class="<%: index++%2==0?"first":"second" %>">
															<td><a href="<%=Url.Action("Index","Price", new {Id=item.PartnerID }) %>"><%: item.Partner!= null?item.Partner.Name:"" %></a></td>
															<td><a href="<%=Url.Action("Index","Price", new {Type=item.SymbolNameID }) %>"><%: item.SymbolType.DisplayName %></a></td>
															<td><%: item.District.DisplayName
                                                             %></td>
															<td><%: Html.FormatCurrency(item.CurrBuyPrice)%></td>
															<td><%: Html.FormatCurrency(item.CurrSellPrice )%></td>
															<td><%: Html.FormatCurrency(item.DailyOpenPrice) %></td>
                                                            <td><%: Html.FormatCurrency(item.DailyClosePrice) %></td>
                                                            <% if (item.DailyPriceChange < 0)
                                                               {  %>
                                                             <td class="negative"><%:Html.FormatCurrency( item.DailyPriceChange)%></td>
                                                             <%}
                                                               else
                                                               { %>
                                                                <td><%: Html.FormatCurrency(item.DailyPriceChange)%></td>
                                                               <%} %>


                                                              <td class="<%: item.AdjustedRate.StartsWith("-")?"negative":"" %>"><%: item.AdjustedRate %></td>

                                                            <td><%: item.UpdateDateTime.Value.ToString("hh:mm tt") %></td>
															<td style="width: 96px;">
																<div class="actions">
																	<ul>
																		<li><a class="action1" href="<%=Url.Action("Index","Price", new {Id=item.PartnerID }) %>">1</a></li>
																		<li><a class="action2" href="#">2</a></li>
																		<li><a class="actionedit" href="<%=Url.Action("Edit","MarketPrice", new {Id=item.MarketPriceID }) %>">3</a></li>
												...
												<%=Html.GeneratePager(Model.Prices, "Price", "Index", "Page", new { Type= Model.Type})%>
