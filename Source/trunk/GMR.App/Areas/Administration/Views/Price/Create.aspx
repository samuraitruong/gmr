<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Administration/Views/Shared/CMS_Restricted.Master" Inherits="System.Web.Mvc.ViewPage<GMR.App.Areas.Administration.Models.CreateMarketPriceModel>" %>
...
<h2>&nbsp;</h2>
<% using (Html.BeginForm("Create","MarketPrice", FormMethod.Post, new {@class="search_form general_form"}))
   { %>
												...
												<!--[if !IE]>start forms<![endif]-->
													...
													<fieldset>
                                                        ...
                                                        <div class="row">
															...
															<div class="inputs">
																<span class="input_wrapper"> <%= Html.TextBoxFor(model => model.CurrBuyPrice, new { @class="text"})%></span>
                                                        ...
                                                        <div class="row">
															...
															<div class="inputs">
																<span class="input_wrapper"> <%= Html.TextBoxFor(model => model.CurrSellPrice, new { @class="text"})%></span>
																<span class="system negative">
                                                        ...
                                                        <div class="row">
															...
															<div class="inputs">
																<span class="input_wrapper"> <%= Html.TextBoxFor(model => model.DailyOpenPrice, new { @class = "text", @readonly="true" })%></span>
                                                         ...
                                                         <div class="row">
															...
															<div class="inputs">
																<span class="input_wrapper"> <%= Html.TextBoxFor(model => model.DailyClosePrice, new { @class = "text" , @readonly="true"})%></span>
																<span class="system negative"></span>
															</div>
														</div>
                                                         <div class="row">
															...
															<div class="inputs">
																<span class="input_wrapper"> <%= Html.TextBoxFor(model => model.DailyPriceChange, new { @class = "text", @readonly = "true" })%></span>
																<span class="system negative"></span>
															</div>
														</div>
