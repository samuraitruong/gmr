<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/Areas/Administration/Views/Shared/CMS.Master" Inherits="System.Web.Mvc.ViewPage<GMR.App.Areas.Administration.Models.EditNewsModel>" %>
...
<h2>&nbsp;</h2>
<% using (Html.BeginForm("Edit", "News", FormMethod.Post, new { @class = "search_form general_form", enctype = "multipart/form-data" }))
   { %>
    <%: Html.ValidationSummary(true)%>
    <%: Html.HiddenFor(p=>p.NewsID) %>
     <%: Html.HiddenFor(p=>p.ImagePath) %>
<!--[if !IE]>start section<![endif]-->	
					<div class="section">
						<!--[if !IE]>start title wrapper<![endif]-->
						<div class="title_wrapper">
							<h2>Thêm quản tin tức</h2>
