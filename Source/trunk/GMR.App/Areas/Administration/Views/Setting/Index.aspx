<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Administration/Views/Shared/CMS.Master" Inherits="System.Web.Mvc.ViewPage<SettingModel>" %>

<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">

<h2>&nbsp;</h2>
<% using (Html.BeginForm("Index", "Setting", FormMethod.Post, new { @class = "search_form general_form", enctype = "multipart/form-data" }))
   { %>
														...
														<div class="row">
															<div class="buttons">
																<ul>
																	...
																	<li><span class="button cancel_btn"><span><a href="<%=Url.Action("Index","Dashboard") %>"><span>QUAY LẠI</span></a></span></li>
																</ul>
